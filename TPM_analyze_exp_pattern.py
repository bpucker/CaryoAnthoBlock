...
__usage__ = """
					python TPM_analyze_exp_pattern.py
					--in <SUMMARY_FILE>
					--out <OUTPUT_FOLDER>
					--taxon <TAXON_FILE>
...
def generate_pathway_overview_figure_broken_yaxis( O, A, B, figurefile, O_group, A_group, B_group, genes, border ):
	...
	for idx, sample in enumerate( A_values ):
		...
		if n > 0:
			if y >= border:
				ax.text( x, y, "n="+str( n ), fontsize=sample_size_fontsize, rotation=90, va="bottom" )
			else:
				ax2.text( x, y, "n="+str( n ), fontsize=sample_size_fontsize, rotation=90, va="bottom" )
		all_Ys.append( y )
	...
	ax.set_ylim( border+1, 2000 )	#max( [ x for sublist in A_values + B_values + O_values for x in sublist ] )
	...
	plt.subplots_adjust( left=0.1, right=0.999, top=0.99, bottom=0.06, hspace=0.03 )
...
def main( arguments ):
	...
	generate_pathway_overview_figure_broken_yaxis( normed_data_O, normed_data_A, normed_data_B, output_folder + "pathway_overview_A2_B2.pdf", "A0", "A2", "B2", genes, 100 )
	...
	generate_pathway_overview_figure_broken_yaxis( normed_data_O, normed_data_A, normed_data_B, output_folder + "pathway_overview_A2_B3.pdf", "A0", "A2", "B3", genes, 100  )
	...
	generate_pathway_overview_figure_broken_yaxis( normed_data_O, normed_data_A, normed_data_B, output_folder + "pathway_overview_A2_B4.pdf", "A0", "A2", "B4", genes, 100  )
	...
	generate_pathway_overview_figure_broken_yaxis( normed_data_O, normed_data_A, normed_data_B, output_folder + "pathway_overview_X_A_B.pdf", "Y", "A", "B", genes, 100  )
